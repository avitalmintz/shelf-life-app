...
export const CATEGORIES: CategoryDefinition[] = [
  ...
  { value: "style",   label: "Clothing / Style",   tw: "bg-cat-style text-cat-style-foreground", context: "Clothing, outfits, shoes, bags, totes, purses, jewelry, accessories, and fashion items." },
  { value: "product", label: "Products to buy",    tw: "bg-cat-product text-cat-product-foreground", context: "Physical products to buy that are not wearable/style items, bags, totes, purses, jewelry, shoes, or fashion accessories." },
